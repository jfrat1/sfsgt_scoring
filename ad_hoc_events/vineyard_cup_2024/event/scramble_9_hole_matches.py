...
class _Matchup(NamedTuple):
    ...
    def display(self) -> None:
        ...
        print(f"{team_1_players}: {team_1_playing_handicap} vs. {team_2_players}: {team_2_playing_handicap}")
        ...
        if team_1_playing_handicap == team_2_playing_handicap:
            ...
            print(f"- {higher_handicap_team} receive {stroke_differential} strokes from {lower_handicap_team}")
